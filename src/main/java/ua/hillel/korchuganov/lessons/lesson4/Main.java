...
//        int b = 4;
//
//        System.out.println(a % b); // 10 / 4 = 2. 2 * 4 = 8
//        System.out.println();
...
//        double tax = 0.05;
//
//        double salary1WithoutTax = salary1 - salary1 * tax;
//        double salary2WithoutTax = salary2 - salary2 * tax;
//        double salary3WithoutTax = salary3 - salary3 * tax;
//
//        System.out.println();
...
//        System.out.println(Math.random()); // 0.0 - 0.99999 [0,1)
//        System.out.println(Math.round(Math.random() * 11));

       // int min = 15;
      //  int max = 30;

        System.out.println((int) ((Math.random() * (77 - 27 + 1)) + 27));
        System.out.println((int) ((Math.random() * (77 - 27 + 1)) + 27));
        System.out.println((int) ((Math.random() * (77 - 27 + 1)) + 27));
        System.out.println((int) ((Math.random() * (77 - 27 + 1)) + 27));
        System.out.println((int) ((Math.random() * (77 - 27 + 1)) + 27));
