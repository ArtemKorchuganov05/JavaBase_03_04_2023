package ua.hillel.korchuganov.lesson16;

import org.junit.jupiter.api.*;
import ua.hillel.korchuganov.lessons.lesson16.ArrayUtil;
...
public class TestArrayUtil {
    ...
    void testMethod1(){
        ...
        Assertions.assertEquals(-2, ArrayUtil.getIndexElement(null,10));
    }
    ...
    @Test
    void testMethod3(){
        Assertions.assertTrue(ArrayUtil.getIndexElement(new int[] {1,2,3},2) == 1);
    }
    @Test
    void testMethod4(){
